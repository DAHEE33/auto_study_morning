...
class GoogleSheetsClient:
    def __init__(self):
        ...
        self.mock_data = {
            "Member_Master": [
                {"닉네임": "dev_user", "UserKey": "UK123", "상태": "활동", "목표시간": "70", "최종누적": "15600", "주간휴무": "1.0", "남은월휴": "1", "예치금": "10000", "비고": "-", "남은특휴": "1", "가입일자": "2026-05-08", "예치금환불": "불가", "예치금소진일자": "-"},
            ],
            "Daily_Log": [],
        ...
        try:
            ...
            if not val1 or not val1[0]:
                ws_member.update("A1", [
                    ...
                    ["dev_user", "UK123", "활동", "70", "15,600", "1.0", "1", "10,000", "-", "1", "2026-05-08", "불가", "-"]
                ])
